...
- Be precise about continuity — only describe someone as "retained", "remaining", or "continuing" in a role if the transcript indicates they already held it; if someone is being newly proposed, approached, or appointed to a role for the first time, say so (e.g. "was proposed", "was approached regarding", "subject to his confirmation") rather than implying they already held it.
