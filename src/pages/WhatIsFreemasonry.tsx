          ...
          <div className="container mx-auto px-6 max-w-3xl">
            <motion.div {...motionProps()}>
              ...
              <p className="text-muted-foreground font-sans leading-relaxed text-lg mb-6">
                Freemasonry is one of the world's oldest social and charitable organisations, with
              ...
              <p className="text-muted-foreground font-sans leading-relaxed text-lg mb-6">
                ...
                more fulfilling lives and contribute positively to their communities. Just as
                stonemasons once wore aprons and gloves to shape rough stone, today's Freemasons
                meet not to build physical structures but to build lasting friendships, develop
                their character and support those around them.
              </p>
              <p className="text-muted-foreground font-sans leading-relaxed text-lg">
                The formation of the United Grand Lodge of England in 1717 marked a defining
                moment, but the traditions of the Craft reach much further into history. Today,
                around 175,000 Freemasons across England and Wales continue to uphold these
                time-honoured values — guided by four principles that are as relevant now as they
                have ever been.
              </p>
            </motion.div>
          </div>
          ...
          <div className="container mx-auto px-6">
            <motion.div {...motionProps()} className="text-center mb-16">
              ...
              <p className="text-primary-foreground/70 font-sans mt-4 max-w-2xl mx-auto">
                Every Freemason in Surrey and across the world progresses through the same three
                stages — each a ceremony rich in symbolism, moral teaching, and personal meaning.
              </p>
            </motion.div>
              ...
              {degrees.map((d, i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-primary-foreground/70 text-xs font-sans uppercase tracking-wide mb-2">
                      {d.degree}
                    </p>
                    <p className="text-sm text-primary-foreground/70 font-sans leading-relaxed">
                      {d.description}
