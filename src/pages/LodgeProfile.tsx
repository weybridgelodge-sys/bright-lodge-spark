        ...
        <section className="py-16 md:py-24 bg-background border-t border-border" aria-labelledby="mission-heading">
          <div className="container mx-auto px-6 max-w-3xl">
            <motion.div variants={fadeUp} initial="hidden" whileInView={shouldReduceMotion ? "static" : "visible"} viewport={{ once: true }} custom={0}>
              ...
              <p className="text-muted-foreground font-sans leading-relaxed">If that sounds like the kind of friendship, structure and purpose you're looking for, the best next step is <Link to="/freemason-initiation-night" className="text-gold hover:underline">Your Initiation Night</Link> — it walks through exactly what to expect, from enquiry to your first evening at Guildford Masonic Centre.</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 max-w-2xl text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView={shouldReduceMotion ? "static" : "visible"} viewport={{ once: true }} custom={0}>
              ...
              <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-4">
                ...
                <Link to="/freemason-initiation-night" className="inline-flex items-center justify-center bg-transparent text-gold border border-gold/40 px-8 py-4 rounded-sm text-sm font-semibold font-sans uppercase tracking-widest hover:opacity-90 transition-opacity min-h-[48px] w-full sm:w-auto">Your Initiation Night</Link>
              </div>
            </motion.div>
          </div>
        </section>
