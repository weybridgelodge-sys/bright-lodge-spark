...
import heroImg from "@/assets/news/surrey-2030-gold-award.jpg";
            ...
            <article className="prose-custom space-y-10">
              ...
              <section id="grand-launch">
                ...
                <p className="text-muted-foreground font-sans leading-relaxed">
                  The Surrey 2030 Festival was officially set in motion by the Provincial Grand Master on Saturday, 30th November 2024. The gala launch at the{" "}
