...
function Inner() {
  ...
  const tiles: Tile[] = [
    ...
    { to: "/members/admin/secretary", title: "Secretary Portal", description: "Meetings, Festive Board Register, LOI Register, Summons Builder, KPI Dashboard and Officers Tracker.", icon: BarChart3, visible: canManageSummons },
