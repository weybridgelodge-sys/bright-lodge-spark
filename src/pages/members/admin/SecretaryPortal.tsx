...
function Inner() {
  ...
  const tiles: Tile[] = [
    ...
    { to: "/members/admin/minutes", title: "Minutes Generator", description: "AI-drafted from your meeting transcript, then reviewed and approved — Regular and Committee minutes, with action items and the source transcript kept alongside.", icon: NotebookPen, visible: canManageSummons },
